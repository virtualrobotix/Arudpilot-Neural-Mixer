# Integrazione di riferimento MicroDuck — training, rete, firmware, risultati

[English](microduck-ppo.md) | **Italiano** · [Torna al README](../../README.it.md)
...
Parametri (`sitl/nnmixer.parm` li imposta per il SITL): `NNM_ENABLE`, `NNM_ROBOT` (topologia del robot, letta al boot), `NNM_POLICY` (indice del file `.nnm` sulla microSD), `NNM_BLEND_MS`,
